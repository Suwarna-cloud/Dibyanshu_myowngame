...
function draw() {
  ...
  if (frameCount % 50 === 0) {
    ...
    enemy4 = Bodies.rectangle(width + 300, random(50, height - 50), 200, 200);
    World.add(world, enemy4);
  ...
  Matter.Body.setVelocity(enemy, { x: -2, y: 0 });
  Matter.Body.setVelocity(enemy2, { x: 2, y: 0 });
  Matter.Body.setVelocity(enemy3, { x: -2, y: 0 });
  Matter.Body.setVelocity(enemy4, { x: -2, y: 0 });
  Matter.Body.setVelocity(enemy5, { x: -2, y: 0 });
  // Matter.Body.applyForce(enemy, { x: 0, y: 0 }, { x: -0.3, y: 0 });
  // Matter.Body.applyForce(enemy2, { x: 0, y: 0 }, { x: -0.3, y: 0 });
  // Matter.Body.applyForce(enemy3, { x: 0, y: 0 }, { x: -0.35, y: 0 });
  // Matter.Body.applyForce(enemy4, { x: 0, y: 0 }, { x: -0.3, y: 0 });
  // Matter.Body.applyForce(enemy5, { x: 0, y: 0 }, { x: -0.3, y: 0 });
...
function create() {
  ...
  // Matter.Body.applyForce(enemy2, { x: 0, y: 0 }, { x: -5, y: 0 });
  // Matter.Body.applyForce(enemy3, { x: 0, y: 0 }, { x: -5, y: 0 });
  // Matter.Body.applyForce(enemy4, { x: 0, y: 0 }, { x: -5, y: 0 });
  // Matter.Body.applyForce(enemy5, { x: 0, y: 0 }, { x: -5, y: 0 });
